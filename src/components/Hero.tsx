...
const Hero: React.FC = () => {
  return (
    <section className="min-h-screen flex items-center px-6 relative lg:pt-20 pt-32 pb-20">
      <div className="container mx-auto max-w-7xl w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-20">
          {/* Text Content */}
          <div className="flex-1 text-center lg:text-left relative">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-2xl px-4 py-3 border border-white/20 mb-8 text-sm sm:text-base sm:px-6">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-8xl xl:text-9xl font-black mb-8 leading-tight">
              Tá caro?{' '}
            ...
            <p className="text-xl sm:text-2xl lg:text-3xl mb-12 text-white/80 leading-relaxed font-light max-w-2xl mx-auto lg:mx-0">
            ...
            {/* Stats */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-8 text-white/70">
              <div className="flex items-center gap-3">
                <Users size={24} className="text-[#DFFF00]" />
                <span className="text-lg">Match por compatibilidade</span>
              </div>
              <div className="flex items-center gap-3">
                <Home size={24} className="text-cyan-300" />
                <span className="text-lg">Organização da casa</span>
              </div>
              <div className="flex items-center gap-3">
                <Zap size={24} className="text-purple-300" />
                <span className="text-lg">Zero burocracia</span>
              </div>
            </div>
          </div>
